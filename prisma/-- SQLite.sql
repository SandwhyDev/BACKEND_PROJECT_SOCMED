...
CREATE TABLE "Post_photo" (
    ...
    CONSTRAINT "Post_photo_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "Post" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Like" (
    ...
    CONSTRAINT "Like_from_id_fkey" FOREIGN KEY ("from_id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Comment" (
    ...
    CONSTRAINT "Comment_from_id_fkey" FOREIGN KEY ("from_id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Reply" (
    ...
    "from_id" INTEGER NOT NULL,
    CONSTRAINT "Reply_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "Post" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Reply_comment_id_fkey" FOREIGN KEY ("comment_id") REFERENCES "Comment" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Reply_from_id_fkey" FOREIGN KEY ("from_id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Follows" (
    ...
    CONSTRAINT "Follows_from_id_fkey" FOREIGN KEY ("from_id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Follows_follow_id_fkey" FOREIGN KEY ("follow_id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
